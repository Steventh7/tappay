...
var GoSellElements = function (_Component) {
  ...
  function GoSellElements() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = GoSellElements.__proto__ || Object.getPrototypeOf(GoSellElements)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(GoSellElements, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps !== prevState) {
        _RootStore2.default.configStore.setConfig(nextProps, "GOSELLELEMENTS");
      }
